<template>
  <div>
    <h3 style="margin-left: 30%">시계열 분석 결과</h3>
    <button
      @click="trainModel"
      style="background-color: lightgrey; border: 2px solid black; margin-left: 100px"
    >
      시계열 모델 훈련
    </button>
    <button
      @click="getForecastData"
      style="background-color: lightgrey; border: 2px solid black; margin-left: 30px"
    >
      구매동향 시계열 그래프 그리기
    </button>
