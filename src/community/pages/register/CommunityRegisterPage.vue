...
// namespace 방식으로 vuex community 모듈을 사용하기 위한 형태
...
export default {
    ...
    methods: {
        // namespace 방식의 vuex community 모듈의 action 기능을 땡겨올 때 사용
        // 그러므로 이것은 communityModule의 action에 정의되어야 함
        // 쉽게 얘기해서 requestCreateCommunityToDjango가 communityModule의 action에 정의되어야 한다는 말
